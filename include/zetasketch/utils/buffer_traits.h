...
class BufferWriter {
 public:
  ...
  // The writer may point at its own local storage; a copy or a move
  // generated by the compiler would leave the copy pointing into the
  // source, so neither exists.
